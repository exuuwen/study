...
#define GLOBALFIFO_SIZE	20	/*全局fifo最大4K字节*/
#define FIFO_CLEAR 0x1  /*清0全局内存的长度*/
#define GLOBALFIFO_MAJOR 233    /*预设的globalfifo的主设备号*/
...
int globalfifo_init(void)
{
  ...
  //init_MUTEX(&globalfifo_devp->open_sem);

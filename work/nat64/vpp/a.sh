...
create host-interface name veth95f4c96
enable tap-inject
set interface state host-veth95f4c96 up
set interface ip address host-veth95f4c96 10.0.0.1/24

create tap host-if-name tap-v4
set interface ip address tap0 192.168.0.1/24 

...
extern int ovs_reject_init(struct net *net);
extern void ovs_reject_exit(struct net *net);
...
struct ctl_path net_ovs_ctl_path[] = {
...
static int __init dp_init(void)
{
	...
	pr_info("Open vSwitch switching datapath %s ipv4tov6, built "__DATE__" "__TIME__"\n",
		VERSION);
	...
	ovs_sysctl_header = register_sysctl_paths(net_ovs_ctl_path, ovs_table);

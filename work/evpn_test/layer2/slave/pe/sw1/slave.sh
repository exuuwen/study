net add interface swp31 ip address 192.168.69.69/24
net add loop lo ip address 10.0.0.69/32
net add loopback lo clag vxlan-anycast-ip 7.7.7.7
net add bond peerlink bond slaves swp1
net add interface peerlink.4094 clag peer-ip 169.254.1.70
net add interface peerlink.4094 clag sys-mac 44:38:39:FF:40:94
net add interface peerlink.4094 ip address 169.254.1.69/24

net add vxlan vni-104001 vxlan id 104001
net add vxlan vni-100100 vxlan id 100100
net add vxlan vni-100200 vxlan id 100200
net add bridge bridge ports vni-104001,vni-100100,vni-100200,swp11,swp21,peerlink
net add bridge bridge pvid 1
net add bridge bridge vids 100,200,4001
net add bridge bridge vlan-aware
net add interface swp11 bridge access 100
net add interface swp21 bridge access 200
...
net add vxlan vni-100100 vxlan local-tunnelip 10.0.0.69
...
net add vxlan vni-100200 vxlan local-tunnelip 10.0.0.69
...
net add vxlan vni-104001 vxlan local-tunnelip 10.0.0.69
...
net del interface swp31 ip address 192.168.69.69/24
net del loopback lo clag vxlan-anycast-ip 7.7.7.7
net del loop lo ip address 10.0.0.69/32
net del vrf vrf1
net del vlan 100
net del vlan 200
net del vlan 4001
...
net add bgp autonomous-system 65069
net add vrf vrf1 vni 104001
net add bgp router-id 10.0.0.69
net add bgp bestpath as-path multipath-relax
net add bgp bestpath compare-routerid
net add bgp neighbor 192.168.69.73 remote-as 65073
net add bgp neighbor 169.254.1.70 remote-as 65070
net add bgp ipv4 unicast network 7.7.7.7/32 
net add bgp l2vpn evpn neighbor 192.168.69.73 activate
net add bgp l2vpn evpn neighbor 169.254.1.70 activate
...
net del bgp autonomous-system 65069

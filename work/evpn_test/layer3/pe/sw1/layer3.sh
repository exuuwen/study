...
net add interface swp11 ip address 172.168.69.69/24
...
net del interface swp11 ip address 172.168.69.69/24
...
net add bgp ipv4 unicast network 10.0.0.69/32 
net add bgp l2vpn evpn neighbor 192.168.69.73 activate
net add bgp l2vpn evpn advertise-all-vni
net add bgp vrf vrf1 autonomous-system 65000
net add bgp vrf vrf1 neighbor 172.168.69.241 remote-as 65241
net add bgp vrf vrf1 ipv4 unicast neighbor 172.168.69.241 activate
...
net add routing route 10.0.1.0/24 172.168.69.241 vrf vrf1

...
nft add rule firewall rule-2000-ingress ct zone 2 ct state established,related counter accept
nft add rule firewall rule-2000-ingress ct zone 2 ct state invalid counter drop
nft add rule firewall rule-2000-ingress ct zone 2 tcp dport 23 ct state new counter accept
...
nft add rule firewall rules-all ct zone vmap { 1 : jump rule-1000-egress, 2 : jump rule-2000-egress } 
...
nft add rule firewall dnat-all ct zone vmap { 1 : jump dnat-1000, 2 : jump dnat-2000 }
...
nft add rule firewall snat-all ct zone vmap { 1 : jump snat-1000, 2 : jump snat-2000 }

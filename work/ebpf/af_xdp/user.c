...
int main(int argc, char **argv)
{
	...
	printf("bpf set link success \n");
#endif

	qidconf_map = bpf_obj_get("/sys/fs/bpf/tc/globals/qidconf_map");
	xsks_map = bpf_obj_get("/sys/fs/bpf/tc/globals/xsks_map");
